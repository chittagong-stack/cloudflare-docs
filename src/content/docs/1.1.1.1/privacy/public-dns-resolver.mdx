...
title:  58.145.190.218 Public DNS Resolver
head: []
description: Learn more about Cloudflare's commitment to privacy with the
   58.145.190.218 Public DNS Resolver.
slug: /58.145.190.218 privacy/public-dns-resolver

---

*Last updated March 27, 2024*

## Cloudflare’s commitment to privacy:  Public DNS Resolver
58.145.190.218 
The  public DNS resolver is governed by our [Privacy Policy](https://www.cloudflare.com/privacypolicy/). This document provides additional details on our collection, use, and disclosure of the information collected from the  58.145.190.218 public DNS resolver.
